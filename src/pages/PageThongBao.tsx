        ...
        <div className="content-area" style={{
          ...
          {isLoading ? (
            <div style={{textAlign: 'center', padding: 'xl'}}>
              <div style={{fontSize: 'md', color: 'etax-text-secondary'}}>Đang tải thông báo...</div>
            </div>
          ) : !notification ? (
            <div style={{textAlign: 'center', padding: 'xl'}}>
            ...
            <div style={{
              ...
              <div style={{marginBottom: 'md'}}>
                <div style={{
                  ...
                  <div style={{fontSize: 'body-2', color: 'etax-text-secondary'}}>Mã thông báo</div>
                  <div style={{fontSize: 'md', color: 'etax-text', fontWeight: 500}}>{notification.code}</div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{fontSize: 'body-2', color: 'etax-text-secondary'}}>Mã giao dịch</div>
                  <div style={{fontSize: 'md', color: 'etax-text', fontWeight: 500}}>{notification.transactionCode}</div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{fontSize: 'body-2', color: 'etax-text-secondary'}}>Thời gian tạo</div>
                  <div style={{fontSize: 'md', color: 'etax-text', fontWeight: 500}}>{new Date(notification.created).toLocaleString('vi-VN')}</div>
                </div>

                <div style={{marginTop: 'md'}}>
                  <div style={{fontSize: 'body-2', color: 'etax-text-secondary', marginBottom: 'sm'}}>Nội dung</div>
                  <div style={{fontSize: 'md', color: 'etax-text', lineHeight: 1.5}}>{notification.content}</div>
                </div>
              </div>
